...
Upload the contents of this ZIP to the root of the GitHub Pages repository, replacing the previous build.
Because Neo 2.0 uses new runtime filenames, it should not require fighting the old v44 cache; closing the previous Safari tab and reopening the site once is still recommended.

## Local preview

Use `PREVIEW-WEBSITE.bat` on Windows, or run:

    python3 -m http.server 8000

from the extracted site folder and open `http://127.0.0.1:8000/`.
