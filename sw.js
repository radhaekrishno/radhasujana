const CACHE="radhasujana-v44.8";
const CORE=["/","/en/","/styles.css?v=44.8","/script.js?v=44.8","/site-config.js?v=44.7","/favicon.png","/manifest.webmanifest?v=44.7","/assets/social-preview.jpg"];
