const CACHE="radhasujana-v41.6";
const CORE=["/","/en/","/styles.css?v=41.6","/script.js?v=41.6","/site-config.js?v=41.6","/favicon.png","/manifest.webmanifest?v=41.6","/assets/social-preview.jpg"];
