const CACHE="radhasujana-v41.1";
const CORE=["/","/en/","/styles.css?v=41.1","/script.js?v=41.1","/site-config.js?v=41.1","/favicon.png","/manifest.webmanifest?v=41.1","/assets/social-preview.jpg"];
