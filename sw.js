const CACHE="radhasujana-v41.2";
const CORE=["/","/en/","/styles.css?v=41.2","/script.js?v=41.2","/site-config.js?v=41.2","/favicon.png","/manifest.webmanifest?v=41.2","/assets/social-preview.jpg"];
