const CACHE="radhasujana-v44.1";
const CORE=["/","/en/","/styles.css?v=44.1","/script.js?v=44.1","/site-config.js?v=44.1","/favicon.png","/manifest.webmanifest?v=44.1","/assets/social-preview.jpg"];
