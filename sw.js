const CACHE="radhasujana-v42.1";
const CORE=["/","/en/","/styles.css?v=42.0","/script.js?v=42.0","/site-config.js?v=42.0","/favicon.png","/manifest.webmanifest?v=42.0","/assets/social-preview.jpg"];
