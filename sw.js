const CACHE="radhasujana-v40.6";
const CORE=["/","/en/","/styles.css?v=40.6","/script.js?v=40.6","/site-config.js?v=40.6","/favicon.png","/manifest.webmanifest?v=40.6","/assets/social-preview.jpg"];
