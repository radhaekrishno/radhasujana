const CACHE="radhasujana-v41.3";
const CORE=["/","/en/","/styles.css?v=41.3","/script.js?v=41.3","/site-config.js?v=41.3","/favicon.png","/manifest.webmanifest?v=41.3","/assets/social-preview.jpg"];
