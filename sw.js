const CACHE="radhasujana-v40.9";
const CORE=["/","/en/","/styles.css?v=40.9","/script.js?v=40.9","/site-config.js?v=40.9","/favicon.png","/manifest.webmanifest?v=40.9","/assets/social-preview.jpg"];
