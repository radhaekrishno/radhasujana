const CACHE="radhasujana-v41.0";
const CORE=["/","/en/","/styles.css?v=41.0","/script.js?v=41.0","/site-config.js?v=41.0","/favicon.png","/manifest.webmanifest?v=41.0","/assets/social-preview.jpg"];
