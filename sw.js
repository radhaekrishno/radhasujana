const CACHE="radhasujana-v40.8";
const CORE=["/","/en/","/styles.css?v=40.8","/script.js?v=40.8","/site-config.js?v=40.8","/favicon.png","/manifest.webmanifest?v=40.8","/assets/social-preview.jpg"];
